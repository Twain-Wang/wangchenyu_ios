...
@property (nonatomic,strong)   UIImageView       *heyhaImageView;
@property (nonatomic, readonly) SVPullToRefreshState state;
@property (nonatomic, readonly) SVPullToRefreshPosition position;
@property (nonatomic,assign ) BOOL showHeyHaImageFirst;//首次显示内容
@property (nonatomic,assign) BOOL  showHeyHaImageView;//是否显示广告栏
@property (nonatomic,assign) BOOL  showHeyHaTeacher;//是否显示teacher版
