...
static CGFloat const SVInfiniteScrollingViewHeight = 42;
...
//        CGFloat scrollOffsetThreshold = scrollViewContentHeight-self.scrollView.bounds.size.height+70;
...
- (void)setCustomView:(UIView *)view forState:(SVInfiniteScrollingState)state {
    ...
    if(!viewPlaceholder)
        viewPlaceholder = @"";
    //此处代码为张雨所加
    for(id item in self.viewForState)
    {
        if([item isKindOfClass:[UIView class]] && viewPlaceholder!=item)
        {
