...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    if(_mydelegate)
    {
        if([_mydelegate respondsToSelector:@selector(willPushViewController)])
        {
            [_mydelegate willPushViewController];
        }
    }
...
- (void)moveViewWithX:(float)x
{
    ...
    if(_mydelegate)
    {
        if([_mydelegate respondsToSelector:@selector(Rateofprogress:)])
        {
            [_mydelegate Rateofprogress:x];
        }
    }
}
